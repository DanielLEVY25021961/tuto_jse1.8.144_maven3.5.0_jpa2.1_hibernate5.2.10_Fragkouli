...
import levy.daniel.application.model.dao.IDaoGenericHibernate;
...
public class BookDaoHibernateTest {
	...
	/**
	 * dao : IDaoGenericHibernate<Book,Long> :<br/>
	 * BookDaoHibernate.<br/>
	 */
	public final transient IDaoGenericHibernate<Book, Long> dao = new BookDaoHibernate();
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(BookDaoHibernateTest.class);
	
	
	// *************************METHODES************************************/
		
	 /**
	 * method CONSTRUCTEUR BookDaoHibernateTest() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * <br/>
	 */
	public BookDaoHibernateTest() {
		super();
...
} // FIN DE LA CLASSE BookDaoHibernateTest.-------------------------------------------
